...
const PieChart = () => {
  ...
  const [sumHorizontal, setSumHorizontal] = useState(dataHorizontalChart.reduce((accumulator, currentValue) => accumulator + currentValue, 0))
  const [dataVerticalChart, setveritcalData] = useState([0,0,3,6])
  const barChartX = {
    options: {
      plotOptions: {
        bar: {
    ...
    <div>
      ...
      <div className="inline-block b-0 shadow-lg rounded-[6px] h-[435px]">
        ...
        <div className="flex flex-row justify-center items-center w-full mt-[40px] bottom-0">
          <div className="w-[13px] h-[13px] bg-[#6D8E55] rounded-sm mr-[4px] opacity-85">

          </div>
          <p className="text-[#ADB5BD] text-[12px] mr-[24px]">Maintech</p>
          <div className="w-[13px] h-[13px] bg-[#E6415C] rounded-sm mr-[4px]">
